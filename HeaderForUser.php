...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="#">KnowledgeKube</a>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                ...
                <form class="d-flex">
                    <a href="Login.php"><button class="btn btn-outline-danger" type="submit"><i
                                class="bi bi-box-arrow-left">&nbsp;Logout</i></button></a>
                </form>
            </div>
        </div>
    </nav>
